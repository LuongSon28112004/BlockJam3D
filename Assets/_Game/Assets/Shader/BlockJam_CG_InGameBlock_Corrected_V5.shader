Shader "BlockJam/CG_InGameBlock_Corrected_V5" {
	Properties {
		_MainTex ("Main Texture", 2D) = "white" {}
		_Tex1 ("Expression Texture 1 (Eyes)", 2D) = "white" {}
		_Tex2 ("Expression Texture 2 (Mouth)", 2D) = "white" {}
		...
		_LightDir ("Light Direction", Vector) = (0.5,0.5,-1,0)
